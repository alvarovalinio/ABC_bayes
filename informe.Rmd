...
Es importante destacar que uno de los supuestos base del modelo es que las mujeres están expuestas al riesgo de concebir inmediatamente luego del matrimonio. A su vez, se asume la no utilización de ningún tipo de métodos anticonceptivo.
...
El modelo construido nos permite observar y cuantificar la incertidumbre subyacente en el fenómeno de estudio, pudiendo observar la existencia de aleatoriedad en las tasas de fecundabilidad por edad. Esto último en función de la parametrización seleccionada.
...
Si bien para valores elevados de epsilon el modelo logra captar el ajuste en las edades avanzadas, el problema persiste en todos los casos para las edades tempranas.

Una posible explicación está en que el modelo considera como parámeros la edad en la que decae la fecundabilidad y la tasa para dicha edad.
...
Este resultado se encuentra en concordancia con lo observado por ... en cuanto al trade off entre precisión y costo computacional. En 




Para futuras investigaciones er que considerar la utilización de métodos anticonceptivos así como también generar salida de unidades por fallecimiento y los fenómenos asociados a las migraciones.
